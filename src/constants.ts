import type { FieldType, SidebarGroup, FieldProps } from "./types";
...
export const icons = {
  ...
  richtext:
    "M6 4h8a4 4 0 014 4 4 4 0 01-4 4H6z M6 12h9a4 4 0 014 4 4 4 0 01-4 4H6z",
  password:
    "M12 2a5 5 0 0 0-5 5v3H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-2V7a5 5 0 0 0-5-5z",
  attachment:
    "M6 7.91V16a6 6 0 006 6 6 6 0 006-6V6a4 4 0 00-4-4 4 4 0 00-4 4v9.18a2 2 0 002 2 2 2 0 002-2V8",
  textlist: "M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01",
  email:
    "M3 8l9 6 9-6v10a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm0-2a2 2 0 012-2h14a2 2 0 012 2L12 12 3 6z",
  ...
  checkboxgroup:
    "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2 M9 3h6v4H9z",
  select: "M19 9l-7 7-7-7",
  grip: "M9 5h2M9 12h2M9 19h2M13 5h2M13 12h2M13 19h2",
  trash:
    "M3 6h18M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6M9 6V4h6v2",

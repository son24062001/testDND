...
var isValidateEmpty = function (value) {
    ...
    if ((0, shared_1.isArr)(value)) {
        ...
        return (0, shared_1.isEmpty)(value);
    }
};
var getLength = function (value) {
    return (0, shared_1.isStr)(value) ? (0, shared_1.stringLength)(value) : value ? value.length : 0;
};
var extendSameRules = function (rules, names) {
    (0, shared_1.each)(names, function (realName, name) {
...
var RULES = {
    format: function (value, rule) {
        if (isValidateEmpty(value))
            return '';
        if (rule.format) {
            var format = (0, registry_1.getValidateFormats)(rule.format);
            if (format) {
    ...
    max: function (value, rule) {
        if (isValidateEmpty(value))
            return '';
        var length = (0, shared_1.isNum)(value) ? value : getLength(value);
    ...
    validator: function (value, rule, context, format) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(0, shared_1.isFn)(rule.validator)) return [3 /*break*/, 2];
                        return [4 /*yield*/, Promise.resolve(rule.validator(value, rule, context, format))];
                    case 1:
                        response = _a.sent();
                        if ((0, shared_1.isBool)(response)) {
    ...
    enum: function (value, rule) {
        if (isValidateEmpty(value))
            return '';
        var enums = (0, shared_1.toArr)(rule.enum);
    ...
    uniqueItems: function (value, rule) {
        if (isValidateEmpty(value))
            return '';
        value = (0, shared_1.toArr)(value);
        return value.some(function (item, index) {
            for (var i = 0; i < value.length; i++) {
                if (i !== index && !(0, shared_1.isEqual)(value[i], item)) {
                    return false;
                }
            }
            return true;

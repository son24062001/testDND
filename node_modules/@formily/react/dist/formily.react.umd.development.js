    ...
    ***************************************************************************** */
    ...
    var RecursionField = function (props) {
        ...
        var renderSlots = function (innerSchema, key) {
            ...
            if (isRenderProp) {
                var args_1 = Formily.Reactive.observable({ $slotArgs: [] });
                Formily.Shared.FormPath.setIn(fieldSchema.properties, target, function () {
                    var _args = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        _args[_i] = arguments[_i];
                    }
                    args_1.$slotArgs = _args;
                    return (React.createElement(ExpressionScope, { value: args_1 },
                        React.createElement(RecursionField, { schema: innerSchema, name: key })));
                });
            }
            else {
                Formily.Shared.FormPath.setIn(fieldSchema.properties, target, React.createElement(RecursionField, { schema: innerSchema, name: key }));
            }
        };
